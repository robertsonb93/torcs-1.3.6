/***************************************************************************
    ...
    version              : $Id: alphabot.cpp,v 1.5.2.2 2008/11/09 17:50:19 berniw Exp $
...
static const char* botname[NBBOTS] = {
	"alphabot 1", "alphabot 2", "alphabot 3", "alphabot 4", "alphabot 5",
	"alphabot 6", "alphabot 7", "alphabot 8", "alphabot 9", "alphabot 10"
};
...
// Module entry point.
extern "C" int alphabot(tModInfo *modInfo)
{
	int i;
